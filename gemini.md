...
## 1. Regras Fundamentais de Economia de Tokens
...
2. **Edições Cirúrgicas e Contíguas:**
   - Não faça varreduras cegas de diretórios nem buscas pesadas (`grep`/`find`) em pastas volumosas (`node_modules`, `.next`, `.git`).
