...
const USD_PER_MTOK: Record<string, Preco> = {
  ...
  'claude-3-5-haiku': { input: 0.8, output: 4, cacheRead: 0.08, cacheWrite5m: 1.0, cacheWrite1h: 1.6 },
  'claude-3-5-haiku-20241022': { input: 0.8, output: 4, cacheRead: 0.08, cacheWrite5m: 1.0, cacheWrite1h: 1.6 },
  'claude-3-5-haiku-latest': { input: 0.8, output: 4, cacheRead: 0.08, cacheWrite5m: 1.0, cacheWrite1h: 1.6 },
  'claude-haiku-4-5': { input: 1, output: 5, cacheRead: 0.1, cacheWrite5m: 1.25, cacheWrite1h: 2 },
  'gemini-2.5-flash-lite': { input: 0.075, output: 0.3, cacheRead: 0.01875, cacheWrite5m: 0.09375, cacheWrite1h: 0.15 },
  'gemini-1.5-flash': { input: 0.075, output: 0.3, cacheRead: 0.01875, cacheWrite5m: 0.09375, cacheWrite1h: 0.15 },
  'gemini-3.5-flash': { input: 0.15, output: 0.9, cacheRead: 0.0375, cacheWrite5m: 0.1875, cacheWrite1h: 0.3 },
